...
const Products = ({ productData }) => {
  ...
  const handleUpload = (event, product) => {
    event.stopPropagation();
    console.log(product);
    dispatch(addStuff("ProductCreate", product)); // itt egy hiba ami undifine-ot ad 
        ...
        {currentItems.map((data, index) => (
          ...
          >
            <ProductContainer>
              ...
              <PriceCost>{data.price.cost} ft</PriceCost>
              <PriceDiscount>{data.price.discountPercent}% Kedvezmény</PriceDiscount>
              <AddToCart>
