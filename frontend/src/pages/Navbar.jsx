            ...
            <Container maxWidth="xl" sx={{ backgroundColor: "#4d1c9c" }}>
                <Toolbar disableGutters>
                            ...
                            <>
                                ...
                                >
                                    <MenuItem onClick={() => {
                                        ...
                                        <Typography textAlign="center">Belépés mint vásárló</Typography>
                                    </MenuItem>
                                    <MenuItem onClick={() => {
                                        navigate("/Sellerlogin")
                                        handleCloseNavMenu()
                                    }}>
                                        <Typography textAlign="center">Belépés mint eladó</Typography>
                                    </MenuItem>
                                </Menu>
                            </>
                        </Box>
                    ...
                    <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' }, }}>
                        <Search />
                        <ProductsMenu dropName="Kategória" />
                        <ProductsMenu dropName="Termékek" />
                    </Box>
                        ...
                        <Box sx={{ flexGrow: 0, display: { xs: 'none', md: 'flex' }, }}>
                            ...
                            >
                                ...
                                <MenuItem onClick={() => navigate("/Sellerlogin")}>
                                    ...
                                    <Link to="/Sellerlogin"> {/*Ezt madj ki kellesz venni */}
                                        Belépés mint eladó
                                    </Link>
                                </MenuItem>
                            </Menu>
