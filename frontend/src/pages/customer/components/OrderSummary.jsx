                    ...
                    <List disablePadding>
                        <ListItem sx={{ py: 1, px: 0 }}>
                            ...
                            <Typography variant="subtitle1" sx={{ fontWeight: 700 }}>
                                {`${productDetailsCart.price && productDetailsCart.price.mrp * productDetailsCart.quantity}ft`}
                            </Typography>
                        </ListItem>
                        <ListItem sx={{ py: 1, px: 0 }}>
                            <ListItemText primary="Discount" />
                            <Typography variant="subtitle1" sx={{ color: "green" }}>
                                {productDetailsCart.price && productDetailsCart.price.mrp - productDetailsCart.price.cost}ft
                            </Typography>
                        </ListItem>
                        <ListItem sx={{ py: 1, px: 0 }}>
                        ...
                        <ListItem sx={{ py: 1, px: 0 }}>
                            ...
                            <Typography variant="subtitle1" sx={{ fontWeight: 700 }}>
                                {productDetailsCart.price && productDetailsCart.price.cost * productDetailsCart.quantity}ft
                            </Typography>
                        </ListItem>
                    </List>
